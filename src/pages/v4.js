      ...
      polaroidRefs.current.forEach((ref, index) => {
        if (ref) {
          ...
          if (rect.top < windowHeight && rect.bottom > 0) {
            ...
            const rotation = (index % 2 === 0 ? 1 : -1) * (1 - progress) * 10;
            const scale = 0.8 + progress * 0.2;
            const opacity = 0.3 + progress * 0.7;

            ref.style.transform = `rotate(${rotation}deg) scale(${scale})`;
    ...
    <div className='min-h-screen bg-gradient-to-b from-amber-50 to-amber-100'>
      <div className='max-w-md mx-auto bg-white shadow-2xl'>
        ...
        >
          ...
          <div className='max-w-4xl mx-auto relative' style={{ minHeight: '800px' }}>
            {/* Photo 1 - Top Left */}
            <div
              ...
              style={{
                transform: `rotate(-5deg) translateX(${scrollY * 0.02}px)`,
                zIndex: 10,
              }}
            >
            ...
            <div
              ...
              style={{
                transform: `rotate(8deg) translateX(-${scrollY * 0.03}px)`,
                zIndex: 15,
              }}
            >
              <div className='relative w-full h-full rounded-lg overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-110'>
            ...
            <div
              ...
              style={{
                transform: `translateX(-50%) rotate(-2deg) scale(${1 + scrollY * 0.0001})`,
                zIndex: 20,
              }}
            >
            ...
            <div
              ...
              style={{
                transform: `rotate(6deg) translateY(${scrollY * 0.02}px)`,
                zIndex: 18,
              }}
            >
              <div className='relative w-full h-full rounded-lg overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-110'>
            ...
            <div
              ...
              style={{
                transform: `rotate(-7deg) translateY(-${scrollY * 0.025}px)`,
                zIndex: 16,
              }}
            >
              <div className='relative w-full h-full rounded-lg overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-110'>
            ...
            {/* Decorative elements */}
            <div className='absolute top-20 right-20 w-32 h-32 bg-amber-200 rounded-full opacity-10 blur-3xl'></div>
            <div className='absolute bottom-40 left-20 w-40 h-40 bg-amber-300 rounded-full opacity-10 blur-3xl'></div>
          </div>
        </section>
